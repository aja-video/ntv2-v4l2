...
/* hdmi input status */
NTV2_REG(ntv2_kona_reg_hdmiin_input_status,			126);		/* hdmi input status register */
...
/* hdmi input control */
NTV2_REG(ntv2_kona_reg_hdmiin_i2c_control,			360);		/* hdmi input i2c control register */
...
NTV2_REG(ntv2_kona_reg_hdmiin_i2c_data,				361);		/* hdmi input data register */
...
NTV2_REG(ntv2_kona_reg_hdmiin_video_setup,			362);		/* hdmi input video setup regiser */
...
NTV2_REG(ntv2_kona_reg_hdmiin_hsync_duration,		363);		/* hdmi input horizontal sync and back porch regiser */
NTV2_REG(ntv2_kona_reg_hdmiin_h_active,				364);		/* hdmi input horizontal active regiser */
NTV2_REG(ntv2_kona_reg_hdmiin_vsync_duration_fld1,	365);		/* hdmi input vertical sync and back porch regiser, field 1 */
NTV2_REG(ntv2_kona_reg_hdmiin_vsync_duration_fld2,	366);		/* hdmi input vertical sync and back porch regiser, field 2 */
NTV2_REG(ntv2_kona_reg_hdmiin_v_active_fld1,		367);		/* hdmi input vertical active regiser, field 1 */
NTV2_REG(ntv2_kona_reg_hdmiin_v_active_fld2,		368);		/* hdmi input vertical active regiser, field 2 */

NTV2_REG(ntv2_kona_reg_hdmiin_video_status,			369);		/* hdmi input video status regiser 1 */
...
NTV2_REG(ntv2_kona_reg_hdmiin_horizontal_data,		370);		/* hdmi input H pixel data */
...
NTV2_REG(ntv2_kona_reg_hdmiin_hblank_data0,			371);		/* hdmi input H blanking data */
...
NTV2_REG(ntv2_kona_reg_hdmiin_hblank_data1,			372);		/* hdmi input H Blanking data */
...
NTV2_REG(ntv2_kona_reg_hdmiin_vertical_data_fld1,	373);		/* hdmi input field 1 V data */
NTV2_REG(ntv2_kona_reg_hdmiin_vertical_data_fld2,	374);		/* hdmi input field 2 V data */
